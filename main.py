...
# === CONFIG ===
BOT_TOKEN = os.getenv("8999257719:AAGfbTa5fJdipcDo0LuaggWhzcZmTvEtxY4")

if not BOT_TOKEN:
    logger.error("❌ BOT_TOKEN not found! Please set your bot token in environment variables.")
    sys.exit(1)

REQUIRED_CHANNELS = ["@freefire_like_office"]
GROUP_JOIN_LINK = "https://t.me/Free_likes_for_Free_Fire"
OWNER_ID = 7564448057
OWNER_USERNAME = "@svat_iiiii"
